...
namespace BeardedManStudios.Forge.Networking.Unity
{
	public partial class NetworkManager : MonoBehaviour
	{
		...
		public GameObject[] BillboardNetworkObject = null;
		public GameObject[] ChatManagerNetworkObject = null;
		public GameObject[] CodeNamesGameStateNetworkObject = null;
		...
		private void CaptureObjects(NetworkObject obj)
		{
			...
			if (obj is BillboardNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					...
					{
						if (BillboardNetworkObject.Length > 0 && BillboardNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(BillboardNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<BillboardBehavior>();
						}
					}
			...
			else if (obj is CodeNamesGameStateNetworkObject)
			{
				MainThreadManager.Run(() =>
				{
					NetworkBehavior newObj = null;
					if (!NetworkBehavior.skipAttachIds.TryGetValue(obj.NetworkId, out newObj))
					{
						if (CodeNamesGameStateNetworkObject.Length > 0 && CodeNamesGameStateNetworkObject[obj.CreateCode] != null)
						{
							var go = Instantiate(CodeNamesGameStateNetworkObject[obj.CreateCode]);
							newObj = go.GetComponent<CodeNamesGameStateBehavior>();
						}
					}
		...
		[Obsolete("Use InstantiateBillboard instead, its shorter and easier to type out ;)")]
		public BillboardBehavior InstantiateBillboardNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(BillboardNetworkObject[index]);
			var netBehavior = go.GetComponent<BillboardBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<BillboardBehavior>().networkObject = (BillboardNetworkObject)obj;
		...
		[Obsolete("Use InstantiateCodeNamesGameState instead, its shorter and easier to type out ;)")]
		public CodeNamesGameStateBehavior InstantiateCodeNamesGameStateNetworkObject(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			var go = Instantiate(CodeNamesGameStateNetworkObject[index]);
			var netBehavior = go.GetComponent<CodeNamesGameStateBehavior>();
			var obj = netBehavior.CreateNetworkObject(Networker, index);
			go.GetComponent<CodeNamesGameStateBehavior>().networkObject = (CodeNamesGameStateNetworkObject)obj;
		...
		/// <summary>
		/// Instantiate an instance of Billboard
		/// </summary>
		/// <returns>
		/// A local instance of BillboardBehavior
		/// </returns>
		/// <param name="index">The index of the Billboard prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public BillboardBehavior InstantiateBillboard(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			if (BillboardNetworkObject.Length <= index)
			{
				Debug.Log("Prefab(s) missing for: Billboard. Add them at the NetworkManager prefab.");
				return null;
			}
		...
		/// <summary>
		/// Instantiate an instance of CodeNamesGameState
		/// </summary>
		/// <returns>
		/// A local instance of CodeNamesGameStateBehavior
		/// </returns>
		/// <param name="index">The index of the CodeNamesGameState prefab in the NetworkManager to Instantiate</param>
		/// <param name="position">Optional parameter which defines the position of the created GameObject</param>
		/// <param name="rotation">Optional parameter which defines the rotation of the created GameObject</param>
		/// <param name="sendTransform">Optional Parameter to send transform data to other connected clients on Instantiation</param>
		public CodeNamesGameStateBehavior InstantiateCodeNamesGameState(int index = 0, Vector3? position = null, Quaternion? rotation = null, bool sendTransform = true)
		{
			if (CodeNamesGameStateNetworkObject.Length <= index)
			{
				Debug.Log("Prefab(s) missing for: CodeNamesGameState. Add them at the NetworkManager prefab.");
				return null;
			}
		...
		{
			if (NodeServiceNetworkObject.Length <= index)
			{
				Debug.Log("Prefab(s) missing for: NodeService. Add them at the NetworkManager prefab.");
				return null;
			}
		...
		{
			if (RandomMovingNPCNetworkObject.Length <= index)
			{
				Debug.Log("Prefab(s) missing for: RandomMovingNPC. Add them at the NetworkManager prefab.");
				return null;
			}
		...
		{
			if (TokenPlayerNetworkObject.Length <= index)
			{
				Debug.Log("Prefab(s) missing for: TokenPlayer. Add them at the NetworkManager prefab.");
				return null;
			}
