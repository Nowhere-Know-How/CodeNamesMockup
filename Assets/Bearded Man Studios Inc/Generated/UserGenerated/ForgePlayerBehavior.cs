...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public abstract partial class ForgePlayerBehavior : NetworkBehavior
	{
		...
		public override void Initialize(NetworkObject obj)
		{
			...
			networkObject = (ForgePlayerNetworkObject)obj;
		...
		{
			Initialize(new ForgePlayerNetworkObject(networker, createCode: TempAttachCode, metadata: metadata));
		}
		...
		{
			return new ForgePlayerNetworkObject(networker, this, createCode, metadata);
		}
